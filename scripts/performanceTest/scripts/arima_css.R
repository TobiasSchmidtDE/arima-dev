...
# 8. "Q":
# 10. "s":
# 11. optional "residuals destination":
# 12. optional "use hdfs": set to true if files are on hdfs and not to be found on local file system
...
#print(args)
if (length(args) < 10) {
  stop("At least 10 arguments need to be provided. Please check the argument list.", call.=FALSE)
}
