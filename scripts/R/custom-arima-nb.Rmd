...
RUN ARMA
```{r}
arima_models = arimamodels(X, 100, 2, 1, 2, 2, 0, 0, 2)
...
testweights = rep.int(0.5, 8)
residuals = arimaResiduals (X, testweights,  2, 50, 2, 2, 1, 2, 12)
css = arima_predict_css(X, testweights, 2, 50, 2, 2, 1, 2, 12)
